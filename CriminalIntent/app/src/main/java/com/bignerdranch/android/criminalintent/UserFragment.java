...
//    private Button mUserList;
    ...
    public static final Fragment newInstance(UUID eventId) {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        UUID eventId = (UUID) getArguments().get(ARG_ID);
    ...
    private class UserAdapter extends RecyclerView.Adapter<UserHolder> {
        ...
        public void add(Participant user, int position) {
            if (!mParticipants.contains(user)) {
                ...
                EventLab.get(UserFragment.this.getActivity()).addUser(user, mEvent.getId());
            } else {
//                notifyDataSetChanged();
        ...
        public void remove(int position) {
            Participant user = mParticipants.get(position);
            EventLab.get(UserFragment.this.getActivity()).deleteUser(user);
        ...
        ItemTouchHelper.SimpleCallback simpleCallback =
                new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
                    ...
                    private void init() {
                        ...
                        xMark = ContextCompat.getDrawable(UserFragment.this.getActivity(), R.drawable.ic_clear_24dp);
