...
import com.bignerdranch.android.criminalintent.database.EventDBSchema.JoinTable;
...
public class EventLab {
    ...
    private static ContentValues getContentValues(UUID userId, UUID eventId) {
        ContentValues values = new ContentValues();
...
//        mCrimes = new ArrayList<>();
    ...
    public void addUser(Participant user, UUID eventId) {
